module ActiveRecord
  ...
  #       record.credit_uid = encrypt(record.credit_uid)
  #     end
  #
  #     def after_save(record)
  #       record.credit_uid = decrypt(record.credit_uid)
  #     end
  #
  ...
  #
  #   class BankAccount < ActiveRecord::Base
  #     before_save      EncryptionWrapper.new("credit_uid")
  #     after_save       EncryptionWrapper.new("credit_uid")
  #     after_initialize EncryptionWrapper.new("credit_uid")
  #   end
  #
  #   class EncryptionWrapper
